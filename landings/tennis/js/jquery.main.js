...
;function initBackgroundText() {
	var titleItem = document.querySelector('.bg-text');
	if (titleItem) {
		var backgroundText = titleItem.getAttribute('data-background-text');
...
function initSlickCarousel() {
	//scroll to gallery
	var navItem = jQuery('.slider-nav .slide-nav-holder');
	navItem.on('click', function () {
		var scrollTarget = jQuery('.gallery-carousel');
